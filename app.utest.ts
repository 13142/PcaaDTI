...
import * as databaseCleaner from "./databaseCleaner"
import * as Q from "q";
...
describe("Database Access", () => {
    let authenticatedSession: request.SuperTest<request.Test>;
