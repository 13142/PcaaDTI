...
// Source: https://raw.githubusercontent.com/DefinitelyTyped/DefinitelyTyped/c779cebd7f18a885b1e956020d884438c1e5566e/multer/index.d.ts
declare module 'multer' {
    ...
    namespace multer {
        ...
        interface StorageEngine {
            _handleFile(req: express.Request, file: File, callback: (error?: any, info?: File) => void): void;
        ...
        interface DiskStorageOptions {
            ...
            destination?: string | ((req: Request, file: File, callback: (error: Error, destination: string) => void) => void);
            ...
            filename?: (req: Request, file: File, callback: (error: Error, filename: string) => void) => void;
        }
