...
function fixEnumTypes(descArray, namesArray) {
...
function nameBadgeOutput(callback) {
    ...
    Q.all([imagePromise, hbsPage, sqlPromise]).then(res1 => {
        ...
        htmlPdf.create(template({
            ...
            sqlData: res1[2][0]
        }), { "base": "file:///F:/Documents/Visual Studio 2015/Projects/PCAAProject/PCAAProject/Public/", width: "8cm", height: "11cm" }).toBuffer((err2, res2) => {
            if (err2) {
                throw err2;
            }
            callback(res2);
